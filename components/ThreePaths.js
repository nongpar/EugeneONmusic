...
const PATHS_BY_PERIOD = {
  morning: [
    ...
    { label: '피아노를 처음 만나는 시간', prefill: '피아노를 처음 배워보고 싶어요. 성인 취미반에 대해 알고 싶습니다.' },
  ...
  noon: [
    ...
    { label: '음악을 처음 만나보고 싶어요', prefill: '음악을 새로 시작해보고 싶어요. 성인 취미반에 대해 알고 싶습니다.' },
  ],
  evening: [
    { label: '하루를 정돈해주는 곡', prefill: '하루를 정돈해주는 음악 한 곡을 권해주시겠어요?' },
    { label: 'EON HALL에 자리를 만들어보고 싶어요', prefill: 'EON HALL에서 발표회나 리사이틀을 열어보고 싶어요. 대관 가능한지 궁금합니다.' },
