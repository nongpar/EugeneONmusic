...
const SOCIAL_KEYWORDS = [
  // 노인 · 시니어 케어
  '복지관', '어르신', '노인', '경로당', '요양원', '양로원', '실버', '데이케어',
  '치매', '알츠하이머',

  // 의료 · 호스피스 · 정신건강
  '병원', '환자', '입원', '소아병동', '정신건강', '정신과',
  '호스피스', '완화의료', '임종', '말기',

  // 장애 · 특수교육
  '발달장애', '자폐', '지적장애', '지체장애', '중증장애',
  '장애인', '시각장애', '청각장애', '장애아동', '장애학생',
  '특수교육', '특수학교', '특수학급',

  // 아동 · 청소년 · 보육
  '아동센터', '지역아동센터', '청소년센터', '청소년쉼터', '보육원', '고아원',
  '그룹홈', '학교밖', '위기청소년', '한부모', '미혼모', '자립지원',

  // 도서관 · 문화 시설
  '도서관', '문화센터', '문화나눔',

  // 다문화 · 이주민
  '다문화', '이주민', '외국인노동자', '난민', '새터민', '탈북',

  // 빈곤 · 취약계층
  '저소득', '취약계층', '소외계층', '독거', '노숙', '쪽방',
